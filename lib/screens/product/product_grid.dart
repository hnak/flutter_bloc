import 'package:bloc_complex/bloc/cart/cart_bloc.dart';
import 'package:bloc_complex/bloc/cart/cart_provider.dart';
import 'package:bloc_complex/bloc/catalog/catalog_bloc.dart';
import 'package:bloc_complex/bloc/catalog/catalog_provider.dart';
import 'package:bloc_complex/bloc/catalog/catalog_slice.dart';
import 'package:bloc_complex/screens/product/product_square.dart';
...
class ProductGrid extends StatelessWidget {
  ...
  Widget _createSquare(
    ...
    return ProductSquare(
      ...
      product: product,
      onTap: () {
        cartBloc.cartAdditionSink.add(CartAddition(product));
      },
    );
  }
}
